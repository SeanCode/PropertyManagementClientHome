    ...
    <ul class="wrap page-navs">
      ...
      <li v-bind:class="{ 'active': hasRoute('/home/pictures') }"><a>物业风采</a>
        <ul class="page-navs-inner">
          ...
          <li class="mtwhite"><a v-link="{ path: '/home/pictures/1' }">领导关怀</a>
          </li>
          <li><a v-link="{ path: '/home/pictures/2' }">荣誉奖励</a>
          </li>
          <li><a v-link="{ path: '/home/pictures/3' }">会议纪实</a>
          </li>
          <li><a v-link="{ path: '/home/pictures/4' }">物业动态</a>
          </li>
          <li><a v-link="{ path: '/home/pictures/5' }">校园绿化</a>
          </li>
        </ul>
      </li>
